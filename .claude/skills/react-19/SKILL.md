...
> Project guardrail: this repo is React Native + Expo, not Next.js web.
> Apply only React-general guidance here; ignore Next.js/server-component sections unless user explicitly asks for web code.
