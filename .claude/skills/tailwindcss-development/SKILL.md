...
> Project guardrail: this skill is web-HTML focused.
> For this repo, prefer `nativewind-ui` and React Native className patterns unless user explicitly requests web Tailwind.
